        ...
        <div id="main" className="alt">
            <section id="one">
                <div className="inner">
                    ...
                    <p>My passion from programming started a couple years ago, after accidentally finding a Python instruction course on YouTube. Ever since I have been trying to learn new languages, concepts, and technologies. What amazes me most about computer science, is how vast it really is, and how much you can do with even a slight knowledge of it.</p>
                    <p>If you want to get to know me better, plase feel free to explore this website, and have a look at my recent blog posts, where I share whats I am up to and my opinions on various topics.</p>
                </div>
            </section>
        </div>
